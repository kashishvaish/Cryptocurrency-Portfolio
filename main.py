...
def app_nav():
  ...
  menu.add_cascade(label="Menu",menu=file_item)
...
def my_portfolio():
  ...
  for i in range(0,300):
    for coin in coins:
      if api["data"][i]["symbol"] == coin[1]:
        ...
        portfolio_id = Label(pycrypto, text=coin[0], bg="#ffffff", fg="black", font="Lato 12", padx="2", pady="2", borderwidth="2", relief="groove")
        portfolio_id.grid(row=coin_row, column=0, sticky=N+S+E+W)

        name = Label(pycrypto, text=api["data"][i]["symbol"], bg="#cccccc", fg="black", font="Lato 12", padx="2", pady="2", borderwidth="2", relief="groove")
        name.grid(row=coin_row, column=1, sticky=N+S+E+W)

        price = Label(pycrypto, text="${:.2f}".format(api["data"][i]["quote"]["USD"]["price"]), bg="white", fg="black", font="Lato 12", padx="2", pady="2", borderwidth="2", relief="groove")
        price.grid(row=coin_row, column=2, sticky=N+S+E+W)

        no_coins = Label(pycrypto, text=coin[2], bg="#cccccc", fg="black", font="Lato 12", padx="2", pady="2", borderwidth="2", relief="groove")
        no_coins.grid(row=coin_row, column=3, sticky=N+S+E+W)

        amount_paid = Label(pycrypto, text="${:.2f}".format(total_paid), bg="white", fg="black", font="Lato 12", padx="2", pady="2", borderwidth="2", relief="groove")
        amount_paid.grid(row=coin_row, column=4, sticky=N+S+E+W)

        current_val = Label(pycrypto, text="${:.2f}".format(current_value), bg="#cccccc", fg="black", font="Lato 12", padx="2", pady="2", borderwidth="2", relief="groove")
        current_val.grid(row=coin_row, column=5, sticky=N+S+E+W)

        pl_coin = Label(pycrypto, text="${:.2f}".format(pl_percoin), bg="white", fg=font_color(float("{:.2f}".format(pl_percoin))), font="Lato 12", padx="2", pady="2", borderwidth="2", relief="groove")
        pl_coin.grid(row=coin_row, column=6, sticky=N+S+E+W)

        totalpl = Label(pycrypto, text="${:.2f}".format(total_pl_coin), bg="#cccccc", fg=font_color(float("{:.2f}".format(total_pl_coin))), font="Lato 12", padx="2", pady="2", borderwidth="2", relief="groove")
  ...
  add_coin = Button(pycrypto, text="Add Coin", bg="#333333", fg="#ffffff", command=insert_coin , font="Lato 12", padx="2", pady="2", borderwidth="2", relief="groove")
  ...
  update_coin_txt = Button(pycrypto, text="Update Coin", bg="#333333", fg="#ffffff", command=update_coin , font="Lato 12", padx="2", pady="2", borderwidth="2", relief="groove")
  ...
  delete_coin_txt = Button(pycrypto, text="Delete Coin", bg="#333333", fg="#ffffff", command=delete_coin , font="Lato 12", padx="2", pady="2", borderwidth="2", relief="groove")
  delete_coin_txt.grid(row=coin_row + 3, column=4, sticky=N+S+E+W)

    

  totalap = Label(pycrypto, text="${:.2f}".format(total_amount_paid), bg="#ffffff", fg="black", font="Lato 12", padx="2", pady="2", borderwidth="2", relief="groove")
  totalap.grid(row=coin_row, column=4, sticky=N+S+E+W)
        
  totalcv = Label(pycrypto, text="${:.2f}".format(total_current_value), bg="#cccccc", fg="black", font="Lato 12", padx="2", pady="2", borderwidth="2", relief="groove")
  totalcv.grid(row=coin_row, column=5, sticky=N+S+E+W)

  totalpl = Label(pycrypto, text="${:.2f}".format(total_pl), bg="#cccccc", fg=font_color(float("{:.2f}".format(total_pl))), font="Lato 12", padx="2", pady="2", borderwidth="2", relief="groove")
  totalpl.grid(row=coin_row, column=7, sticky=N+S+E+W)

  api = ""

  refresh = Button(pycrypto, text="Refresh", bg="#333333", fg="#ffffff", command=reset , font="Lato 12", padx="2", pady="2", borderwidth="2", relief="groove")
  refresh.grid(row=coin_row + 1, column=7, sticky=N+S+E+W)

def app_header():
  portfolio_id = Label(pycrypto, text="Portfolio ID", bg="#333333", fg="#ffffff", font="Lato 12 bold", padx="5", pady="5", borderwidth="2", relief="groove")
  portfolio_id.grid(row=0, column=0, sticky=N+S+E+W)
  
  name = Label(pycrypto, text="Coin Name", bg="#333333", fg="#ffffff", font="Lato 12 bold", padx="5", pady="5", borderwidth="2", relief="groove")
  name.grid(row=0, column=1, sticky=N+S+E+W)

  price = Label(pycrypto, text="Price", bg="#333333", fg="#ffffff", font="Lato 12 bold", padx="5", pady="5", borderwidth="2", relief="groove")
  price.grid(row=0, column=2, sticky=N+S+E+W)

  no_coins = Label(pycrypto, text="Coin Owned", bg="#333333", fg="#ffffff", font="Lato 12 bold", padx="5", pady="5", borderwidth="2", relief="groove")
  no_coins.grid(row=0, column=3, sticky=N+S+E+W)

  amount_paid = Label(pycrypto, text="Total Amount Paid", bg="#333333", fg="#ffffff", font="Lato 12 bold", padx="5", pady="5", borderwidth="2", relief="groove")
  amount_paid.grid(row=0, column=4, sticky=N+S+E+W)

  current_val = Label(pycrypto, text="Current Value", bg="#333333", fg="#ffffff", font="Lato 12 bold", padx="5", pady="5", borderwidth="2", relief="groove")
  current_val.grid(row=0, column=5, sticky=N+S+E+W)

  pl_coin = Label(pycrypto, text="P/L Per Coin", bg="#333333", fg="#ffffff", font="Lato 12 bold", padx="5", pady="5", borderwidth="2", relief="groove")
  pl_coin.grid(row=0, column=6, sticky=N+S+E+W)

  totalpl = Label(pycrypto, text="Total P/L With Coin", bg="#333333", fg="#ffffff", font="Lato 12 bold", padx="5", pady="5", borderwidth="2", relief="groove")
